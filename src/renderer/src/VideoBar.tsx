...
export default function VideoBar() {
  ...
  // La molette ne règle le son nulle part, pas même sur le haut-parleur.
  // Windows l'envoie à la fenêtre qui est sous le curseur, même quand on
  // travaille ou joue dans une autre (`MouseWheelRouting`), et cette fenêtre-ci
  // ne prend jamais le premier plan : chaque coup de molette qui lui parvient
  // vient d'ailleurs. Sur l'image, puis sur le seul haut-parleur, le son
  // baissait « tout seul » — trois plaintes pour un même symptôme. Le curseur
  // et le clic suffisent.
      ...
      <div className={cn('absolute inset-x-0 bottom-0 transition-opacity duration-200', fondu)}>
        ...
        <div className="flex h-11 min-w-0 items-center gap-0.5 pb-1 pl-1.5 pr-1">
          ...
          {/* Le curseur ne se déplie qu'au besoin : dans 480 points de large,
              chaque élément permanent est pris sur le titre. */}
